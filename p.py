...
def normalize_text(text):
    """إزالة كل شيء عدا الأحرف والأرقام مع إزالة الحروف 'ـ' و 'ى'"""
    # إزالة أي شيء غير حرف أو رقم أو الحروف 'ـ' و 'ى'
    text = re.sub(r'[^أ-يa-zA-Z0-9]', '', text)  # إزالة جميع الرموز والأنماط غير الحروف والأرقام
